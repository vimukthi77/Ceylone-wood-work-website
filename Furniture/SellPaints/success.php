...
<nav class="navbar navbar-expand-lg navbar-dark">
    ...
    <div class="success-container">
        ...
        <div class="success-message">Your Paint order Placed Successful!</div>
        <div class="success-text">You will recive an conformaiton email as soon as posible</div>
        <a href="http://localhost/Furniture/SellPaints/SellPaints.php" class="btn btn-primary">Return to paint Items</a><br><br>
